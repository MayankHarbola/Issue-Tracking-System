app.controller('TesterChart',function($scope,$window,myfactory){
    var manupulatedData = {
    ...
    function printData(){
        $scope.unsolved = manupulatedData.open + manupulatedData.solved + manupulatedData.tbd + manupulatedData.nab;
