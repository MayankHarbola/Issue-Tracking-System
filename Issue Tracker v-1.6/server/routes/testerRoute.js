...
app.post("/reopen",(req,res)=>{
   var json = req.body;
   IssueOperation.reopenDesc(json,res);
})

app.post("/postIssue",(req,res)=>{
  var json = req.body;
  IssueOperation.postIssue(json,res);
})


app.post("/closebug",(req,res)=>{
  var json = req.body;
  IssueOperation.closebug(json,res);
})
